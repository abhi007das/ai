    ...
    <header className="bg-slate-800 border-b border-slate-700 px-4 py-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
                      <button
              onClick={onMenuClick}
              className="lg:hidden p-2 rounded-lg hover:bg-slate-700 text-slate-300 hover:text-white"
            >
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent w-80"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Notifications */}
          <button className="relative p-2 rounded-lg hover:bg-slate-700 text-slate-300 hover:text-white">
          ...
          <div className="relative" ref={profileMenuRef}>
            <button 
              ...
              className="flex items-center space-x-2 p-2 rounded-lg hover:bg-slate-700 text-slate-300 hover:text-white"
            >
              ...
              {showProfileMenu && (
                ...
                >
                  ...
                  <button 
                    ...
                    className="w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-red-900/20 hover:text-red-300 flex items-center space-x-2"
                  >
